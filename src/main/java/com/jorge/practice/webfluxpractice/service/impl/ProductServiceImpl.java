...
public class ProductServiceImpl implements IProductService {
    ...
    public Mono<Product> create(ProductDto productDto) {
        return productRepository.findByName(productDto.getName())
                .hasElement()
                .flatMap(exists -> exists ? Mono.error(new ProductException(HttpStatus.BAD_REQUEST, NAME_ALREADY_USED))
    ...
    public Flux<ProductDto> findAll() {
        return productRepository.findAll()
                ...
                .switchIfEmpty(Mono.error(new ProductException(HttpStatus.BAD_REQUEST, PRODUCT_LIST_EMPTY)));
    }
    ...
    public Mono<ProductDto> findById(Long id) {
        return productRepository.findById(id)
                .map(productMapper::productToProductDto)
                .switchIfEmpty(Mono.error(new ProductException(HttpStatus.NOT_FOUND, PRODUCT_NOT_FOUND)));
    }
